...
# 🦁 XXD Panel 104｜سجلّ النقاط وروح الزِن

### يعيد تحرير الصورة بأشكال نقطية وخطوط ملونة وفراغ هادئ
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 104 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

حين تستحق الصورة إعادة سرد تصميمية من دون تكديس الزخرفة، يحتفظ **Panel 104** بمشهدها الواقعي ويختزل عنصرها الأشد رسوخاً في الذاكرة إلى شكل من النقاط النصفية. تنشئ خطوط ملونة قليلة وخلفية فاتحة واسعة وملاحظات تحريرية خفيفة نظاماً ذا ملمس طباعي وإحساس هادئ بالزمن.

### مناسب لـ

- إزالة السياق المشتت مع الحفاظ على العنصر والحدود والوضع والعلاقة السردية الجديرة بالتذكر؛
- اكتساب طابع طباعي تجريبي من دون أن تتحول العناصر الرسومية إلى فوضى؛
- استخدام مركز الثقل والكثافة والتباعد لجعل الفراغ الهادئ مقصوداً لا خالياً؛
- ملصقات معارض ورسوم تحريرية وأغلفة ثقافية وتصميم مستقل ونسب متعددة وخلفيات ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 104 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** طباعة نقاط نصفية · تدخل خطي ملون · تكوين متكامل · فراغ فني · روح زِن دقيقة · تعليق تحريري
...
|---|---|
| **الناتج** | ملصق تحريري تجمعه طباعة النقاط والخطوط الملونة والفراغ الفني وضبط زِن الدقيق |
| **البصمة الواضحة** | هيكل نقطي داكن، تغير كثافة، مسارات ملونة قليلة، خلفية فاتحة، تعليقات خفيفة، وتكوين متكامل |
| **احترام المصدر** | يحفظ الهوية والوضع والعلاقات السردية؛ اللون من الصورة والاختزال لخدمة نقاط الذاكرة |
| **الاستخدامات** | المعارض الفنية والتصميم التحريري التجريبي والملصقات الثقافية والأغلفة والتصميم المستقل والنسب والخلفيات |
<!-- xxd-panel-benefit:end -->

## منطق التحويل

```text
تحديد الموضوع والعلاقات الأشد رسوخاً → حذف الخلفية الكاملة والتفاصيل الزائدة → الاختزال إلى أشكال نقطية وبنيات جزئية قليلة → بناء الهيكل بالكثافة والطبقات الطباعية → إضافة خطوط ملونة قليلة من الأصل → إكمال التكوين بالفراغ والحروف الخفيفة والنظام التحريري
```

## سمات النتيجة النهائية

- تصنع النقاط السوداء أو الداكنة والحبيبات وتغير الكثافة الهيكل الأساسي، ويبقى العنصر قابلاً للتعرّف بعد استخلاصه.
- تخدم المسارات الملونة والحلقات وعلامات الإحاطة والخطوط الإرشادية العاطفة والاتجاه والهواء والزمن لا الزخرفة.
- تترك الخلفية العاجية أو البيضاء الدافئة أو شديدة الخفة فراغاً واسعاً يمنح العلامات القليلة توتراً.
- يتبع النص الخطوط أو يقترب من العنصر المنقّط أو يلامس حافة الفراغ بخفة منضبطة.
- تجنّب الرسم الواقعي والزخرفة عديمة المعنى وتكديس العناصر والمرشحات الرخيصة والكرتون والقوالب.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-104-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 104. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-104 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-104 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-104 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-104 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-104 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 104 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-104 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-104`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-104-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-104-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–104 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
...
### القيادة العامة لـ Xiaoxiaodong · Skill القائد العام · 104 يوان صيني

تمنحك دفعة واحدة قدرها 104 يوان صيني Skill القائد العام لهذه السلسلة (`xxd-panel-all`) لإدارة جميع Skills الجنود والتوصية بها واستدعائها وتنسيق العمل الدفعي. اكتب «Skill القائد العام» في رسالة WeChat.
